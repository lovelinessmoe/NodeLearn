...
;(function ($, window, document, undefined) {
    ...
    function reposition(thisthat) {
        ...
        switch (obj.settings.position) {
            case 'tipso-top':
                ...
                if (pos_top < $win.scrollTop()) {
                    ...
                    tipso_bubble.find('.tipso_arrow').css({
                        'border-bottom-color': obj.settings.borderColor,
                        'border-top-color': 'transparent'
                    });
                    tipso_bubble.removeClass('tipso-top tipso-bottom tipso-left tipso-right');
                    tipso_bubble.addClass('bottom');
                } else {
                    tipso_bubble.find('.tipso_arrow').css({
                        'border-top-color': obj.settings.borderColor,
            ...
            case 'tipso-bottom':
                ...
                if (pos_top + realHeight(tipso_bubble) > $win.scrollTop() + $win.outerHeight()) {
                    ...
                    tipso_bubble.removeClass('tipso-top tipso-bottom tipso-left tipso-right');
                    tipso_bubble.addClass('tipso-top');
                } else {
                    tipso_bubble.find('.tipso_arrow').css({
                        'border-bottom-color': obj.settings.borderColor,
                        'border-top-color': 'transparent'
            ...
            case 'tipso-left':
                ...
                if (pos_left < $win.scrollLeft()) {
                    ...
                    tipso_bubble.find('.tipso_arrow').css({
                        'border-right-color': obj.settings.borderColor,
                    ...
                    tipso_bubble.find('.tipso_arrow').css({
                        'border-left-color': obj.settings.borderColor,
        ...
        if (pos_left < $win.scrollLeft() && (obj.settings.position == 'tipso-bottom' ||
            obj.settings.position == 'tipso-top')) {
            tipso_bubble.find('.tipso_arrow').css({
        ...
        if (pos_left + obj.settings.width > $win.outerWidth() && (obj.settings.position ==
            'tipso-bottom' || obj.settings.position == 'tipso-top')) {
        ...
        if (pos_left < $win.scrollLeft() && (obj.settings.position == 'tipso-left' ||
            obj.settings.position == 'tipso-right')) {
            ...
            if (pos_top < $win.scrollTop()) {
                ...
                tipso_bubble.removeClass('tipso-top tipso-bottom tipso-left tipso-right');
                tipso_bubble.addClass('tipso-bottom');
            } else {
                tipso_bubble.find('.tipso_arrow').css({
                    'border-top-color': obj.settings.borderColor,
                    'border-bottom-color': 'transparent',
        ...
        if (pos_left + obj.settings.width > $win.outerWidth() && (obj.settings.position ==
            'tipso-left' || obj.settings.position == 'tipso-right')) {
            pos_left = $e.offset().left + ($e.outerWidth() / 2) - (tipso_bubble.outerWidth() /
                2);
            tipso_bubble.find('.tipso_arrow').css({
                marginLeft: -8,
